    ...
    <script> /*script jquery*/
      $(document).ready(function(){
        ...
        $('#btn_login').click(function(){
          ...
          if($('#campo_cpf').val() == ''){ //caso o campo não possua valor as bordas ficam vermelhas
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <button type="button" class="btn btn-info btn-sm">
              <a href="loginMedico.php" class="linha1 nav-link active" onclick="">Área do Profissional</a>
            </button>
          </li>
        </ul>
      </div>
    ...
    <div class="container"> <!--Inicio do Container-->
      <div class="row rounded"> <!--Inicio da ROW-->
        <div class="first-column col-lg-4 col-md-6 col-sm-6"> <!--Primeira coluna-->
            ...
            <p class="description description-primary">O site possibilita o agendamento online, para isso, o usuário deve fazer seu pré-cadastro no sistema, caso contrario só terá acesso a essa tela de login.</p>
            <p class="description description-primary">Após fazer o login, agendando sua consulta pelo site Saúde Pública de Telêmaco Borba você pode escolher a melhor data e horário disponíveis.</p>
            <p class="pCadastro">Ainda não é cadastrado?</p> 
            <!--Botão para cadastro-->
            <a class="btn btn-sm btn-outline-light" href="cadastro.php" role="button"><i class="fa fa-fw fa-user"></i>&nbsp;Cadastre-se aqui</a>               
        ...
        <div class="second-column col-lg-5 col-md-6 col-sm-6"> <!--Segunda coluna-->
          ...
          <form method="POST"> <!--Inicio do FORMULARIO-->
            <h2 class="title title-second">Entrar como Paciente</h2>
            <div class="form-group"> <!--Campo cpf-->
              <label class="badge badge-info" for="campo_cpf">CPF</label>
              <input type="number" class="form-control" name="cpf_paciente" id="campo_cpf" size="11" maxlength="11" placeholder="Digite o CPF">           
            </div> <!--Fim Campo cpf-->
