<?php
  require_once 'app/classes/Pacientes.php'; //primeiro preciso trazer o documento para cá
      ...
      <div class="collapse navbar-collapse justify-content-between" id="nav1">
        <ul class="navbar-nav ml-auto">
            <button type="button" class="btn btn-info btn-sm">
              <a href="index.php" class="linha1 nav-link active" onclick=""><i class="fa fa-sign-out">Logar paciente</i></a>
            </button>
        </ul>
      </div>
        </ul>
      ...
      <div class="row rounded"> <!--Inicio da ROW-->
        ...
        <div class="second-column col-lg-5 col-md-6 col-sm-6"> <!--Segunda coluna-->
            ...
            <form method="POST"> <!--Inicio do FORMULARIO-->
              <h2 class="title title-second">Cadastrar Paciente</h2>
